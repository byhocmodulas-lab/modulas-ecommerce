...
import {
  LayoutDashboard, Link2, TrendingUp, Wallet,
  Settings, ArrowLeft, ChevronRight, Briefcase, Upload, BarChart2,
} from "lucide-react";

const NAV = [
  { href: "/creator",               label: "Dashboard",     icon: LayoutDashboard, exact: true },
  { href: "/creator/opportunities", label: "Opportunities", icon: Briefcase },
  { href: "/creator/submissions",   label: "Submissions",   icon: Upload },
  { href: "/creator/links",         label: "Affiliate Links", icon: Link2 },
      ...
      <div className="border-b border-black/6 bg-white">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-4 px-6 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif text-sm text-charcoal">Creator Hub</span>
          </div>
          <span className="rounded-full bg-pink-100 border border-pink-200 px-3 py-0.5 font-sans text-[10px] tracking-[0.1em] uppercase text-pink-700 font-medium">
            Creator
          </span>
        </div>
      </div>
