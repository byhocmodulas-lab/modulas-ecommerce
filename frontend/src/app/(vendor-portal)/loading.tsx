export default function VendorPortalLoading() {
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-charcoal-950 animate-pulse">
      {/* Sidebar */}
      ...
      <div className="flex-1 overflow-auto p-8 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="h-9 w-28 rounded-full bg-charcoal-200 dark:bg-charcoal-700" />
        </div>
        ...
        <div className="h-72 rounded-2xl bg-charcoal-200 dark:bg-charcoal-700" />
      </div>
    </div>
  );
}
