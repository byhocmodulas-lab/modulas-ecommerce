...
export const metadata: Metadata = {
  title: "About Modulas — Bespoke Furniture Studio, Gurgaon",
  description:
    "Learn about Modulas — a contemporary luxury furniture studio founded in 2021 in Gurgaon, India. 850+ projects, 98% client satisfaction. Bespoke furniture designed with architectural precision.",
  alternates: { canonical: "https://modulas.in/about" },
};
...
const MILESTONES = [
  {
    ...
    body: "Modulas is founded in Gurgaon with a singular mission: to redefine how interiors are experienced through bespoke furniture built around the client's life — not the other way around.",
  },
  {
    year: "2022",
    title: "First 100 Projects",
    body: "Word spreads through architects and interior designers across Delhi-NCR. The studio completes its first 100 residential projects, each fully customised to the client's exact brief.",
  },
  {
    year: "2023",
    title: "The Digital Configurator",
    body: "Real-time 3D configuration launches — clients design their own pieces down to material, finish, and dimension before a single cut is made. No more compromises.",
  },
  {
    year: "2024",
    title: "850+ Projects Completed",
    body: "Modulas crosses 850 completed projects with a 98% client satisfaction rate and a 4.9/5 rating. The team expands to serve clients across major Indian cities.",
  },
  {
    year: "2025",
    title: "The Next Chapter",
    body: "Expanding the experience centre, deepening our craft partnerships, and scaling the modular platform to serve architects, developers, and discerning homeowners across India.",
  },
];
...
const VALUES = [
  {
    label: "Craftsmanship",
    description:
      "Every piece is crafted with obsessive attention to detail — precise joinery, hand-selected materials, and finishes that age beautifully. We believe furniture should outlast trends.",
    image: "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=85",
  },
  {
    label: "Design Precision",
    description:
      "We approach furniture the way architects approach buildings — with rigorous attention to proportion, material, and function. Every dimension is intentional. Nothing is arbitrary.",
    image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&q=85",
  },
  {
    label: "Personalisation",
    description:
      "No two spaces are alike, and no two Modulas pieces are identical. We configure every solution around your space, your lifestyle, and your aesthetic — down to the last detail.",
...
const TEAM = [
  {
    ...
    quote: "Luxury isn't about price — it's about intention. Every decision we make is intentional.",
  },
  {
    name: "Priya Sharma",
    role: "Creative Director",
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=85",
    quote: "Good furniture disappears into a room. You stop seeing the piece and start experiencing how you live.",
  },
  {
    name: "Arjun Kapoor",
    role: "Head of Projects",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=85",
    quote: "We don't just deliver furniture — we deliver a space that feels entirely yours.",
  },
];
...
export default function AboutPage() {
  return (
    <>
      ...
      {/* ── Stats bar ─────────────────────────────────────────────── */}
      <section className="bg-charcoal-950 border-t border-cream/8">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-20 py-10">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {STATS.map((s) => (
              <div key={s.label} className="text-center">
                <p className="font-serif text-4xl text-gold mb-1">{s.value}</p>
                <p className="font-sans text-[11px] tracking-[0.2em] uppercase text-cream/40">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-[1440px] grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-5 font-sans text-[15px] leading-relaxed text-charcoal/65">
              ...
              <p>
                Our mission is to create spaces where luxury feels personal, design is intentional, and every interior stands out. Whether it's a modular kitchen, a bespoke wardrobe, or a fully configured living space — every Modulas piece begins with your brief and ends with a space that is unmistakably yours.
              </p>
              <p>
      ...
      <section className="bg-white py-24 px-6 lg:px-20">
        <div className="mx-auto max-w-[1440px]">
          ...
          <h2 className="font-serif text-4xl text-charcoal mb-16 max-w-lg">Four years of building something real</h2>
          <div className="relative">
